...
const part1Result = findTwoEntriesForSum(input, 2020);
console.log(`Part 1 answer: ${part1Result}`);

/*
  PART 2
*/
const findThreeEntriesForSum = (arr, sum) => {
  for (let i = 0; i < arr.length; i++) {
    for (let j = i + 1; j < arr.length; j++) {
...
const part2Result = findThreeEntriesForSum(input, 2020);
